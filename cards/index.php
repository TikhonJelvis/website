...
<script src="js/Card.js" type="text/javascript" language="javascript"></script>
...
<script src="js/Solitaire.js" type="text/javascript" language="javascript"></script>
...
<div class="content">
  <div id="disclaimer">
    ...
    <p> 
      All in all our goal was met: with our library, you could easily
      implement games like War or Klondike Solitaire without worrying
      about pesky underlying details. The Klondike game, for example,
      is less than 100 lines! War is even shorter.
    </p>
    <span class="hideable">
      <p>
    ...
    <p>
      ...
      on the graphics and visual design.
    </p>
  </div>
</div>
